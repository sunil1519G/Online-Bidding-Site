...
<html lang="en">
  ...
  <body>
                      ...
                      <div class='row'> 
                        ...
                        <div class='col-xl-4 col-md-6'>
                          <?php
                            ...
                            echo "<i class='fas fa-arrow-alt-circle-right'></i> "."<b>Product Description :  </b>".$ans2['description']."<br>";
                          
                            echo "<br><br>";
                            echo "<a class='btn btn-success' href='detailsPublic.php?productid=".$ans2['productid']."&pc=".$product_cat."'>
                                  Full Description  </a> ";
                          ?>
                        </div>
                      </div>
    ...
    <footer class="jumbotron text-center bg-dark">
    	<div class="text-white">Copyright &copy; 2018 &mdash; Bidding Website </div>
    </footer>  
    <!-- Optional JavaScript -->
